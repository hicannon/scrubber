...
\usepackage{graphics} % for pdf, bitmapped graphics file
\usepackage{multicol}
...
\begin{figure}[hb]
\centering
\includegraphics[width=1\textwidth]{assets/browncarpet.png}
\caption{Brown carpet}
\label{fig:contrast_fail}
\end{figure}

\begin{figure}[hb]
\centering
\includegraphics[width=1\textwidth]{assets/cameratable.png}
\caption{Camera table}
\label{fig:contrast_fail}
\end{figure}

\begin{figure}[hb]
\centering
\includegraphics[width=1\textwidth]{assets/carpet.png}
\caption{Carpet}
\label{fig:contrast_fail}
\end{figure}
...
\begin{figure}[hb!]
\centering
\includegraphics[width=1\textwidth]{assets/ketchup.png}
\caption{Carpet}
\label{fig:ketchup}
\end{figure}
...
\begin{figure}[hb!]
\centering
\includegraphics[width=1\textwidth]{assets/milkface.png}
\caption{Carpet}
\label{fig:contrast_fail}
\end{figure}
...
\begin{figure}[hb!]
\centering
\includegraphics[width=1\textwidth]{assets/wood.png}
\caption{Carpet}
\label{fig:contrast_fail}
\end{figure}
